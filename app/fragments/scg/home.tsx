...
export default function Home() {
  return (
    <div className="bp5-running-text">
      <h1 className="bp5-heading">Welcome to Signature Commons Graph</h1>
      <p className="bp5-text-large bp5-text-muted">An interactive knowledge enrichment tool for user-driven meta-graph traversal</p>
      <hr />
      <p>
