...
export default function SessionStatus({ session_id }: { session_id: string }) {
  ...
  if (status.state === 'RUNNING') return <div className="alert alert-success prose prose-lg max-w-none justify-center">All executions are now being sent to CAVATICA worker.</div>
