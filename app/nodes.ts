...
import { MetaNode, MetaNodeAny, MetaNodeData, MetaNodeProcessPrompt, MetaNodeProcessResolve } from '@/spec/metanode'
...
export const processNodes = nodes.reduce<Record<string, MetaNode<MetaNodeProcessPrompt | MetaNodeProcessResolve>>>((N, component) => component.t.kind === 'process' ? {...N, [component.t.spec]: component as any} : N, {})
