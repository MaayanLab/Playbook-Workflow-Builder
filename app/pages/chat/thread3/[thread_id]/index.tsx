...
import { GPTAssistantThread3Delete, GPTAssistantThread3Message, GPTAssistantThread3MessagesList } from "@/app/api/client"
...
export default function ChatThread() {
  ...
  const { data: messages, mutate } = useAPIQuery(GPTAssistantThread3MessagesList, { thread_id: router.query.thread_id as string })
  const { trigger, isMutating } = useAPIMutation(GPTAssistantThread3Message, { thread_id: router.query.thread_id as string })
  const { trigger: triggerDelete } = useAPIMutation(GPTAssistantThread3Delete, { thread_id: router.query.thread_id as string })
