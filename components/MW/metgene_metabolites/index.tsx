...
export const MetgeneMetabolites = MetaNode('MetgeneMetabolites')
  ...
  .story(props =>
    `The gene was then searched in the Metabolomics Workbench [\\ref{The Metabolomics Workbench, https://www.metabolomicsworkbench.org/}] to identify associated metabolites.`
  )
  .build()
