...
export const BarChartsFromScoredT = [ScoredDiseases, ScoredDrugs, ScoredGenes, ScoredPathways, ScoredPhenotypes, ScoredTissues].map(ScoredT =>
  MetaNode(`BarChartFrom[${ScoredT.spec}]`)
    ...
    .story(props => ({
      ...
      methods: `The table in ${props.input_refs?.terms} are visualized with a horizontal bar graph using Plotly.js\\ref{Plotly Technologies Inc. Collaborative data science. Montréal, QC, 2015. https://plot.ly}.`,
