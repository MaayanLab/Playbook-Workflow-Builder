...
export const LogNormalizeGeneCountMatrix = MetaNode('LogNormalizeGeneCountMatrix')
  ...
  .story(props => ({
    ...
    methods: `The the gene count matrix ${props.input_refs?.matrix} was normalized using a log2+1 transformation.`,
    tableLegend: `A log2+1 normalized gene count matrix.`,
  }))
  .build()
