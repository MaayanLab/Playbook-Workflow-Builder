...
import pandas as pd
import json
from components.data.metabolite_count_matrix import metanndata_from_file
import numpy as np
...
def createmetpcanometa(metabolite_count_matrix):
    dataset = metanndata_from_file(metabolite_count_matrix)
...
def createmetametpcagraph(metanndata):
