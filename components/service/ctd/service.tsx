...
export const CTD_Graph_Nodes = MetaNode('CTD_Graph_Nodes')
  ...
  .resolve(async (props) => {
    ...
    abstract: Citable.text`CTD is applied which diffuses through all nodes in STRING [${Citable.doi('10.1093/nar/gku1003')}] to identify nodes that are "guilty by association" and highly connected to the initial gene set of interest [${Citable.doi('10.1371/journal.pcbi.1009551')}, ${Citable.doi('10.1016/j.isci.2022.105799')}].`
  })).build()
...
export const GeneSet_CTD_Wikipathways = MetaNode('GeneSet_CTD_Wikipathways')
  ...
  .resolve(async (props) => {
    ...
    abstract: Citable.text`CTD is applied which diffuses through all nodes in WikiPathways [${Citable.doi('10.1093/nar/gkad960')}] to identify nodes that are "guilty by association" and highly connected to the initial gene set of interest [${Citable.doi('10.1371/journal.pcbi.1009551')}, ${Citable.doi('10.1016/j.isci.2022.105799')}].`
  })).build()
