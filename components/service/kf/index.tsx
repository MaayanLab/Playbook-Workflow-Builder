...
export const KFTumorExpression = MetaNode('KFTumorExpression')
  ...
  .story(props => ({ abstract: `Gene expression in tumors for ${props.inputs ? props.inputs.gene_info.symbol : 'the gene'} were queried from the Open Pediatric Cancer Atlas API [\\ref{doi:10.1016/j.xgen.2023.100340}].` }))
  .build()
...
export const KFTumorExpressionFromGene = MetaNode('KFTumorExpressionFromGene')
  ...
  .story(props => ({ abstract: `Gene expression in tumors for ${props.inputs ? props.inputs.gene : 'the gene'} were queried from the Open Pediatric Cancer Atlas API [\\ref{doi:10.1016/j.xgen.2023.100340}].` }))
  .build()
