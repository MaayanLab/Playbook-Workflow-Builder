...
export const KFTumorExpression = MetaNode('KFTumorExpression')
  ...
  .story(props => ({
    ...
    tableLegend: `A table showing the median expression of the gene in various tumors from the Open Pediatric Cancer Atlas API\\ref{doi:10.1016/j.xgen.2023.100340}.`,
  }))
  .build()
