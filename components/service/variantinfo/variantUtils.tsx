export let variantIdResolveErrorMessage = "The provided id(s) format is not recognized. Please check the list of ids that can be accepted by Allele Registry and try again.";
