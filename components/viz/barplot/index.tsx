...
export const BarplotFromScoredT = [ScoredDiseases, ScoredDrugs, ScoredGenes, ScoredPathways, ScoredPhenotypes, ScoredTissues, ScoredMetabolites, ScoredGlycans].map(ScoredT =>
  MetaNode(`BarplotFrom[${ScoredT.spec}]`)
    ...
    .story(props => ({
      ...
      methods: `The table in ${props.input_refs?.terms} is visualized with a vertical bar graph using Plotly.js\\ref{Plotly Technologies Inc. Collaborative data science. Montreal, QC, 2015. https://plot.ly}.`,
