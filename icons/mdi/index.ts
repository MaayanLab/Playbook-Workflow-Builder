...
import bp4Changes from '@blueprintjs/icons/src/generated/20px/paths/changes'; export const differential_expression_icon = { path: bp4Changes.join(' '), title: 'Differential Expression', size: 20 }
